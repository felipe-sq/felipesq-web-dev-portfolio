  ...
  },
  {
    ...
    caseStudy: {
      ...
      approach: [
        ...
        "Make being wrong safe rather than rare. The original text of every ingredient is kept and never rewritten, not by editing and not by scaling. Structured fields are an overlay on top of it, and the item name falls back to the whole line when nothing can be isolated, so it is never empty.",
      ...
      challenges: [
        'Reading a capital T as a teaspoon. Unit lookup folded case before matching, so "3 T. butter" became three teaspoons instead of three tablespoons. In recipe convention capital T is tablespoon and lowercase t is teaspoon. That is the one place case carries meaning, and the error is threefold in the direction that ruins the dish.',
      ...
      outcome: [
        "397 tests, all in the logic layer, with no component tests by design.",
